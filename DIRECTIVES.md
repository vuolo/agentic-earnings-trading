...
Standing instructions from the operator (Mike). Every agent sees this file in
its context pack. Edit freely — plain English; keep it short (truncated past
~1200 chars). The system reads it fresh on every agent run.

## Current standing directives (2026-07-05)
